...
namespace OTPManager.UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        private SystemNavigationManager NavManager => SystemNavigationManager.GetForCurrentView();
        ...
        protected override void OnActivated(IActivatedEventArgs e)
        {
            ...
            {
                var uri = (e as ProtocolActivatedEventArgs).Uri;
                var uriService = Mvx.Resolve<IUriService>();
                uriService.CreateGeneratorFromUri(uri);
            }
        ...
        void OnNavigated(object sender, NavigationEventArgs e)
        {
            ...
            NavManager.AppViewBackButtonVisibility = visibility;
        }
